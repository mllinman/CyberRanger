...
const potentialPaths = [
  path.join(__dirname, '..'),           // Server directory (where we copy .next in production: /app when running from /app/dist)
...
if (!clientDir) {
  console.error('❌ Could not find a valid client directory with .next build!')
  console.error('Searched paths:', potentialPaths)
  throw new Error('Client directory not found. Please ensure the client is built before starting the server.')
}
